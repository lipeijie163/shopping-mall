<template>
  <div class="bottom-menu">
    <div class="select-all">
      <cart-check-bar class="eddcheck"
                    :is-checked='checkClick' @click.native="allClick"></cart-check-bar>
      <span>全选</span>
    </div>
...
<script>
  import CartCheckBar from 'components/content/cartCheck/CartCheckBar'
  export default {
    components: {
      CartCheckBar
    },
